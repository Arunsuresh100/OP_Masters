                        ...
                        {activeTab === 'support' && (
                            <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-700">
                                <div className="grid grid-cols-1 xl:grid-cols-5 gap-10">
                                    ...
                                    <div className="xl:col-span-2 bg-white/[0.02] border border-white/10 rounded-[15px] p-6 sm:p-8 shadow-2xl relative overflow-hidden group">
                                        ...
                                        <div className="relative z-10">
                                            <div className="flex items-center gap-4 mb-8">
                                                ...
                                                <div>
                                                    <h3 className="text-xl font-black text-white uppercase tracking-tighter italic leading-none mb-1.5">Direct Uplink</h3>
                                                    <p className="text-[9px] font-black text-slate-500 uppercase tracking-[0.2em] opacity-60">Admin Secure Line</p>
                                                </div>
                                            </div>
                                            ...
                                            <form className="space-y-6" onSubmit={(e) => {
                                                ...
                                                <div className="space-y-6">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <input name="subject" required type="text" placeholder="Identify Subject..." className="w-full bg-slate-950/50 border border-white/5 rounded-xl px-5 py-3 text-xs font-black text-white placeholder-slate-700 focus:outline-none focus:border-indigo-500/50 transition-all" />
                                                    </div>
                                                    <div className="space-y-2">
                                                        <label className="text-[9px] font-black text-slate-600 uppercase tracking-widest ml-1">Encrypted Log Entry</label>
                                                        <textarea name="message" required rows="4" placeholder="Input transmission parameters..." className="w-full bg-slate-950/50 border border-white/5 rounded-2xl px-5 py-4 text-xs font-black text-white placeholder-slate-700 focus:outline-none focus:border-indigo-500/50 transition-all resize-none"></textarea>
                                                    </div>
                                                </div>

                                                <div className="pt-2">
                                                    <button type="submit" className="w-full py-4 bg-white text-slate-950 rounded-xl font-black uppercase text-[10px] tracking-[0.2em] shadow-2xl hover:bg-amber-400 hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-center gap-3 group/send">
                                                        Engage Transmission
                                                        <ArrowUpRight className="w-3.5 h-3.5 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                                                    </button>
                                                    <p className="text-[8px] font-black text-slate-600 uppercase tracking-widest mt-4 text-center italic opacity-60">
                                                        Response will be transmitted to: <span className="text-indigo-400">{user.email}</span>
                                                    </p>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div className="xl:col-span-3 space-y-6">
                                        ...
                                        <div className="space-y-6 max-h-[600px] overflow-y-auto no-scrollbar pr-1">
                                            {userTickets.length === 0 ? (
                                                <div className="p-16 text-center bg-white/[0.01] border border-dashed border-white/5 rounded-[15px] text-slate-700 text-[10px] font-black uppercase italic tracking-[0.2em]">
                                                    No ongoing transmissions detected
                                                </div>
                                            ) : (
                                                userTickets.map((ticket) => (
                                                    <div key={ticket.id} className="p-6 bg-white/[0.02] border border-white/10 rounded-[15px] hover:border-amber-500/20 transition-all duration-500 group relative">
                                                        ...
                                                        <h4 className="text-[12px] font-black text-white uppercase tracking-tight mb-2 group-hover:text-amber-500 transition-colors line-clamp-1">{ticket.subject}</h4>
                                                        <p className="text-[9px] text-slate-600 font-bold uppercase tracking-widest line-clamp-2 leading-relaxed italic">{ticket.message}</p>
