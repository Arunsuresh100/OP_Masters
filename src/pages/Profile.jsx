                ...
                <div className=\"bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl border border-white/10 p-8 mb-6 relative overflow-hidden\">
                    ...
                    <div className=\"relative flex flex-col md:flex-row items-center gap-6\">
                        ...
                        <div className=\"flex-1 text-center md:text-left\">
                            ...
                            <div className=\"flex flex-col sm:flex-row items-center gap-4 text-sm text-slate-400 justify-center md:justify-start\">
                                ...
                                <div className=\"flex items-center gap-2\">
                                    ...
                                    <span>Joined {new Date(user.joinedDate || Date.now()).toLocaleDateString('en-US', { month: 'short', year: 'numeric' })}</span>
                                </div>
                            </div>
                            <div className=\"mt-4\">
                        ...
                        <div className=\"grid grid-cols-3 gap-4 md:gap-6\">
                            <div className=\"text-center\">
                                <div className=\"text-2xl font-black text-amber-500 mb-1\">{listings.length}</div>
                                <div className=\"text-[9px] font-bold text-slate-500 uppercase tracking-wider\">Listings</div>
                            </div>
                            <div className=\"text-center\">
                                <div className=\"text-2xl font-black text-emerald-500 mb-1\">{sales.length}</div>
                                <div className=\"text-[9px] font-bold text-slate-500 uppercase tracking-wider\">Sold</div>
                            </div>
                            <div className=\"text-center\">
                                <div className=\"text-2xl font-black text-blue-500 mb-1\">{purchases.length}</div>
                    ...
                    <div className=\"bg-slate-900 border border-white/10 rounded-2xl p-6\">
                        <div className=\"flex items-center gap-3 mb-6\">
                            ...
                            <div>
                                ...
                                <p className=\"text-xs text-slate-500\">Cards you've sold</p>
                            </div>
                        </div>
                        ...
                        {sales.length === 0 ? (
                            ...
                            <div className=\"space-y-3 max-h-[500px] overflow-y-auto\">
                                {sales.map((sale) => (
                                    <div key={sale.id} className=\"bg-slate-950/50 border border-white/10 rounded-xl p-4 hover:border-amber-500/30 transition-all\">
                                        <div className=\"flex gap-3\">
                                            <img 
                                                src={sale.card.image} 
                                                alt={sale.card.name} 
                                            ...
                                            <div className=\"flex-1\">
                                                <div className=\"font-bold text-white text-sm mb-1\">{sale.card.name}</div>
                                                <div className=\"text-[10px] text-slate-500 font-mono\">{sale.card.id}</div>
                                                <div className=\"mt-2 flex justify-between text-xs\">
                                                    <span className=\"text-slate-500\">Sale Price:</span>
                                                    <span className=\"text-amber-400 font-mono font-bold\">{formatPrice(sale.total, currency, USD_TO_INR)}</span>
                                                </div>
