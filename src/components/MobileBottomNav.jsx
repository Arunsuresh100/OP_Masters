...
const MobileBottomNav = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-[4000] bg-slate-950/80 backdrop-blur-lg border-t border-white/10">
      <nav className="grid grid-cols-4 h-16">
          ...
          {user ? (
            ...
            <button 
              ...
              className="flex flex-col items-center justify-center gap-1 text-slate-500 hover:text-slate-300 transition-all active:scale-95"
            >
